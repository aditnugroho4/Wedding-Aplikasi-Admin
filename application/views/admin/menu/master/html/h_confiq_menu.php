...
<?php $this->load->view('admin/menu/master/function/f_confiq_menu'); ?>
        ...
        <div class="container-fluid">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <a class="btn btn-app bg-pink" id="btnAddSub">
                        <i class="fas fa-file-alt"></i>Add SubMenu
                    </a>         
                                ...
                                <div class="row">
                                    <div class="col-12 col-xs-12 col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="txtMenu" onfocus="$.queryLength(this,'#cnt-mn');" maxlength="20" placeholder="Home" class="form-control"required>
                            ...
                            <div class="card-body">	
                                <div class="row">
                                    ...
                                    <div class="form-group">
                                            ...
                                            <input type="text" id="txtMenu_e" onfocus="$.queryLength(this,'#cnt-mn_e');" maxlength="20" placeholder="ex.: Home | Akbar Grup Paket Wedding" class="form-control" required>
                                            <span class="float-right"><i id="cnt-mn_e">0</i> : 20 characters</span>
                                        </div>
                                        <div class="form-group">
                                            <label for="txtTitle_e">Title</label>
                                            <textarea type="text" id="txtTitle_e"  onfocus="$.queryLength(this,'#cnt-tl_e');" rows="2" cols="50" maxlength="60" placeholder="ex.: Home | Akbar Grup Paket Wedding" class="form-control" required></textarea>
                                            <span class="float-right"><i id="cnt-tl_e">0</i> : 60 characters</span>
                                        </div>
                                        <div class="form-group">
                                            <label for="txtDeskripsi_e">Deskripsi</label>
                                            <textarea type="text" id="txtDeskripsi_e"  onfocus="$.queryLength(this,'#cnt-dk_e');" rows="4" cols="50" maxlength="155" placeholder="ex.: Promo tahun ini dari akbar" class="form-control" required></textarea>
                                ...
                                <div class="row">
                                    <div class="col-12 col-xs-12 col-lg-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="txtSubMenu" onfocus="$.queryLength(this,'#cnt-mn_s');" maxlength="20" placeholder="Home" class="form-control"required>
                                            <span class="float-right"><i id="cnt-mn_s">0</i> : 20 characters</span>
                                        </div>
                                        <div class="form-group">
                                            <label for="txtSubTitle">Title</label>
                                            <textarea type="text" id="txtSubTitle" onfocus="$.queryLength(this,'#cnt-tl_s');" rows="2" cols="50" maxlength="60" placeholder="Wedding Planner terbaik di Bogor" class="form-control"required></textarea>
                                            <span class="float-right"><i id="cnt-tl_s">0</i> : 60 characters</span>
                                        </div>
                                        <div class="form-group">
                                            <label for="txtSubDeskripsi">Deskripsi</label>
                                            <textarea type="text" id="txtSubDeskripsi" onfocus="$.queryLength(this,'#cnt-dk_s');" rows="4" cols="50" maxlength="155" placeholder="cari wedding planner terbaik di bogor" class="form-control" required></textarea>
                                    ...
                                    <div class="col-12 col-xs-12 col-lg-6">
                                        ...
                                        <div class="form-group ">
                                            ...
                                            <div class="input-group">
                                                <input type="text" id="txtSubAuthor" onfocus="$.queryLength(this,'#cnt-au_s');" maxlength="60" placeholder="akbargrup wedding planner" class="form-control "required>
                                            </div>
                                        ...
                                        <div class="form-group ">
                                            ...
                                            <div class="input-group">
                                                <input type="text" id="txtSubKeyword" onfocus="$.queryLength(this,'#cnt-ky_s');" maxlength="500" value="akbargrup,wedding bogor" class="form-control "required>
                                            </div>
